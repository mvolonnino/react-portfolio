...
import { MDBIcon, MDBBtn, MDBCard, MDBCardBody, MDBRow, MDBCol } from "mdbreact";
        ...
        <div className="col">
          <MDBCard color="white" text="black" className="text-center mb-2">
            <MDBCardBody>
              ...
              <p>
                My name is Matt Volonnino. I graduated from Plymouth State University in May of 2019. I have always had a
                love for coding since my college years. I was able to take a couple coding classes but was not able to fully
                commit as I was getting a Business Adminstration degree and playing Division III Ice Hockey while working for
                a restaurant called Merlands in New Hampshire. My first job after college was working in the billing
                department for Chubb Insurance and I knew that this was not the right job for me. That is why I took the leap
                and did the Rutgers Coding Bootcamp to get my Full Stack Development Certificate, and so glad that I did!
                <br />
                <br />
